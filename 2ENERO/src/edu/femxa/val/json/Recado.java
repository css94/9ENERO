...
public class Recado implements Comparable <Recado> {
	...
	public int compareTo(Recado recao){
		/*
		 * SI THIS ES MAYOR QUE RECAO
		 * 	DEVUELVE UN NUMERO POSITVO;
		 * SI THIS ES MENOR QUE RECAO
		 * 	DEVUELVE UN NUMERO NEGATIVO;
		 * SINO DEVUELVE 0 (cero) => NO SON IGUALES.
		 */
		String t1=this.getTelefono();
		String t2= recao.telefono;
